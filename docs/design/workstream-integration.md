...
> Status: **partially implemented** (serialized fast-path queue and configuration shipped;
> integrate-agent recovery and client retry/merge-all surfaces remain follow-ups). Sequel to
