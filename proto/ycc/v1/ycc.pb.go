...
type ProjectInfo struct {
	...
	NeedsOnboarding *bool `protobuf:"varint,4,opt,name=needs_onboarding,json=needsOnboarding,proto3,oneof" json:"needs_onboarding,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ProjectInfo) GetNeedsOnboarding() bool {
	if x != nil && x.NeedsOnboarding != nil {
...
func (x *SessionSummary) GetContextTokens() int64 {
	if x != nil {
...
type SessionPresentationRow struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	PositionSeq   int64                  `protobuf:"varint,2,opt,name=position_seq,json=positionSeq,proto3" json:"position_seq,omitempty"`
	UpdatedSeq    int64                  `protobuf:"varint,3,opt,name=updated_seq,json=updatedSeq,proto3" json:"updated_seq,omitempty"`
...
func (x *SessionPresentationRow) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SessionPresentationRow) GetPositionSeq() int64 {
	if x != nil {
		return x.PositionSeq
	}
	return 0
}

func (x *SessionPresentationRow) GetUpdatedSeq() int64 {
	if x != nil {
		return x.UpdatedSeq
	}
	return 0
...
func (x *SessionPresentationRow) GetEvents() []*Event {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *SessionPresentationRow) GetHasDetail() bool {
	if x != nil {
		return x.HasDetail
	}
	return false
...
type SessionViewQuestion struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SessionViewQuestion) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SessionViewQuestion) GetOptions() []string {
	if x != nil {
		return x.Options
	}
	return nil
...
type SessionViewState struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	IndexedThroughSeq  int64                  `protobuf:"varint,1,opt,name=indexed_through_seq,json=indexedThroughSeq,proto3" json:"indexed_through_seq,omitempty"`
	LastEventTimestamp string                 `protobuf:"bytes,2,opt,name=last_event_timestamp,json=lastEventTimestamp,proto3" json:"last_event_timestamp,omitempty"`
	Phase              string                 `protobuf:"bytes,3,opt,name=phase,proto3" json:"phase,omitempty"` // running | paused | idle | error | stopped
	ErrorMessage       string                 `protobuf:"bytes,4,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	ErrorRetryable     bool                   `protobuf:"varint,5,opt,name=error_retryable,json=errorRetryable,proto3" json:"error_retryable,omitempty"`
	CoordinatorModel   string                 `protobuf:"bytes,6,opt,name=coordinator_model,json=coordinatorModel,proto3" json:"coordinator_model,omitempty"`
	ContextTokens      int64                  `protobuf:"varint,7,opt,name=context_tokens,json=contextTokens,proto3" json:"context_tokens,omitempty"`
	HasContextTokens   bool                   `protobuf:"varint,8,opt,name=has_context_tokens,json=hasContextTokens,proto3" json:"has_context_tokens,omitempty"`
	RolloverAvailable  bool                   `protobuf:"varint,9,opt,name=rollover_available,json=rolloverAvailable,proto3" json:"rollover_available,omitempty"`
	PendingQuestions   []*SessionViewQuestion `protobuf:"bytes,10,rep,name=pending_questions,json=pendingQuestions,proto3" json:"pending_questions,omitempty"`
...
func (x *SessionViewState) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SessionViewState) GetIndexedThroughSeq() int64 {
	if x != nil {
		return x.IndexedThroughSeq
	}
	return 0
}

func (x *SessionViewState) GetLastEventTimestamp() string {
	if x != nil {
...
func (x *SessionViewState) GetPhase() string {
	if x != nil {
		return x.Phase
	}
	return ""
...
func (x *SessionViewState) GetErrorMessage() string {
	if x != nil {
...
func (x *SessionViewState) GetErrorRetryable() bool {
	if x != nil {
...
func (x *SessionViewState) GetCoordinatorModel() string {
	if x != nil {
		return x.CoordinatorModel
	}
	return ""
...
func (x *SessionViewState) GetContextTokens() int64 {
	if x != nil {
		return x.ContextTokens
	}
	return 0
...
func (x *SessionViewState) GetHasContextTokens() bool {
	if x != nil {
		return x.HasContextTokens
	}
	return false
}

func (x *SessionViewState) GetRolloverAvailable() bool {
	if x != nil {
		return x.RolloverAvailable
	}
	return false
}

func (x *SessionViewState) GetPendingQuestions() []*SessionViewQuestion {
	if x != nil {
...
func (x *SessionViewState) GetPendingRowId() string {
	if x != nil {
		return x.PendingRowId
	}
	return ""
}
...
type GetSessionViewRequest struct {
	...
	SessionId     string                 `protobuf:"bytes,2,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	MaxRows       int32                  `protobuf:"varint,3,opt,name=max_rows,json=maxRows,proto3" json:"max_rows,omitempty"`    // daemon clamps to a safe range; zero uses the default
	MaxBytes      int32                  `protobuf:"varint,4,opt,name=max_bytes,json=maxBytes,proto3" json:"max_bytes,omitempty"` // complete encoded response budget; zero uses default; daemon enforces a safe minimum
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSessionViewRequest) GetMaxRows() int32 {
	if x != nil {
		return x.MaxRows
	}
	return 0
...
func (x *GetSessionViewRequest) GetMaxBytes() int32 {
	if x != nil {
		return x.MaxBytes
	}
	return 0
...
type GetSessionViewResponse struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	State         *SessionViewState         `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	Rows          []*SessionPresentationRow `protobuf:"bytes,2,rep,name=rows,proto3" json:"rows,omitempty"`
	EarlierCursor string                    `protobuf:"bytes,3,opt,name=earlier_cursor,json=earlierCursor,proto3" json:"earlier_cursor,omitempty"` // opaque, empty when all earlier rows are included
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSessionViewResponse) GetRows() []*SessionPresentationRow {
	if x != nil {
		return x.Rows
	}
	return nil
...
func (x *GetSessionViewResponse) GetEarlierCursor() string {
	if x != nil {
		return x.EarlierCursor
	}
	return ""
}

type GetSessionViewPageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Project       string                 `protobuf:"bytes,1,opt,name=project,proto3" json:"project,omitempty"`
	SessionId     string                 `protobuf:"bytes,2,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
...
func (x *GetSessionViewPageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetSessionViewPageRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *GetSessionViewPageRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *GetSessionViewPageRequest) GetMaxRows() int32 {
	if x != nil {
		return x.MaxRows
	}
	return 0
...
func (x *GetSessionViewPageRequest) GetMaxBytes() int32 {
	if x != nil {
		return x.MaxBytes
	}
	return 0
...
type GetSessionViewPageResponse struct {
	state             protoimpl.MessageState    `protogen:"open.v1"`
	Rows              []*SessionPresentationRow `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty"`
	EarlierCursor     string                    `protobuf:"bytes,2,opt,name=earlier_cursor,json=earlierCursor,proto3" json:"earlier_cursor,omitempty"`
	IndexedThroughSeq int64                     `protobuf:"varint,3,opt,name=indexed_through_seq,json=indexedThroughSeq,proto3" json:"indexed_through_seq,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *GetSessionViewPageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetSessionViewPageResponse) GetEarlierCursor() string {
	if x != nil {
		return x.EarlierCursor
	}
	return ""
...
func (x *GetSessionViewPageResponse) GetIndexedThroughSeq() int64 {
	if x != nil {
		return x.IndexedThroughSeq
	}
	return 0
...
type GetSessionViewDetailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Project       string                 `protobuf:"bytes,1,opt,name=project,proto3" json:"project,omitempty"`
	SessionId     string                 `protobuf:"bytes,2,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
...
func (x *GetSessionViewDetailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetSessionViewDetailRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *GetSessionViewDetailRequest) GetRowId() string {
	if x != nil {
		return x.RowId
	}
	return ""
...
type GetSessionViewDetailResponse struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Row           *SessionPresentationRow `protobuf:"bytes,1,opt,name=row,proto3" json:"row,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSessionViewDetailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type SubscribeSessionViewRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SessionId     string                 `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
...
func (x *SubscribeSessionViewRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SubscribeSessionViewRequest) GetFromSeq() int64 {
	if x != nil {
		return x.FromSeq
	}
	return 0
...
type SessionViewUpdate struct {
	state          protoimpl.MessageState    `protogen:"open.v1"`
	Seq            int64                     `protobuf:"varint,1,opt,name=seq,proto3" json:"seq,omitempty"`
	State          *SessionViewState         `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`
	UpsertedRows   []*SessionPresentationRow `protobuf:"bytes,3,rep,name=upserted_rows,json=upsertedRows,proto3" json:"upserted_rows,omitempty"`
	DeletedRowIds  []string                  `protobuf:"bytes,4,rep,name=deleted_row_ids,json=deletedRowIds,proto3" json:"deleted_row_ids,omitempty"`
	TransientEvent *Event                    `protobuf:"bytes,5,opt,name=transient_event,json=transientEvent,proto3" json:"transient_event,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SessionViewUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SessionViewUpdate) GetState() *SessionViewState {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *SessionViewUpdate) GetUpsertedRows() []*SessionPresentationRow {
	if x != nil {
		return x.UpsertedRows
	}
	return nil
}

func (x *SessionViewUpdate) GetDeletedRowIds() []string {
	if x != nil {
		return x.DeletedRowIds
	}
	return nil
}

func (x *SessionViewUpdate) GetTransientEvent() *Event {
	if x != nil {
		return x.TransientEvent
	}
	return nil
}
...
type ModelConfig struct {
	...
	Disabled        *bool                  `protobuf:"varint,14,opt,name=disabled,proto3,oneof" json:"disabled,omitempty"` // temporarily unavailable; omission preserves existing state
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ModelConfig) GetDisabled() bool {
...
type TestModelResponse struct {
	...
	ErrorKind     string                 `protobuf:"bytes,4,opt,name=error_kind,json=errorKind,proto3" json:"error_kind,omitempty"` // normalized provider failure kind; empty on success
	Status        int32                  `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`                       // provider HTTP status when available
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TestModelResponse) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *TestModelResponse) GetErrorKind() string {
	if x != nil {
		return x.ErrorKind
	}
	return ""
...
func (x *TestModelResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
const file_ycc_v1_ycc_proto_rawDesc = "" +
	...
	"\x03git\x18\x03 \x01(\v2\x11.ycc.v1.GitStatusR\x03git\x12.\n" +
	"\x10needs_onboarding\x18\x04 \x01(\bH\x00R\x0fneedsOnboarding\x88\x01\x01B\x13\n" +
	"\x11_needs_onboarding\"\xd3\x01\n" +
	"\tGitStatus\x12\x16\n" +
	...
	"\x06events\x18\x01 \x03(\v2\r.ycc.v1.EventR\x06events\"\xb2\x01\n" +
	"\x16SessionPresentationRow\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fposition_seq\x18\x02 \x01(\x03R\vpositionSeq\x12\x1f\n" +
	"\vupdated_seq\x18\x03 \x01(\x03R\n" +
	"updatedSeq\x12%\n" +
	"\x06events\x18\x04 \x03(\v2\r.ycc.v1.EventR\x06events\x12\x1d\n" +
	"\n" +
	...
	"\x0ferror_retryable\x18\x05 \x01(\bR\x0eerrorRetryable\x12+\n" +
	"\x11coordinator_model\x18\x06 \x01(\tR\x10coordinatorModel\x12%\n" +
	"\x0econtext_tokens\x18\a \x01(\x03R\rcontextTokens\x12,\n" +
	"\x12has_context_tokens\x18\b \x01(\bR\x10hasContextTokens\x12-\n" +
	"\x12rollover_available\x18\t \x01(\bR\x11rolloverAvailable\x12H\n" +
	...
	"\bmax_rows\x18\x03 \x01(\x05R\amaxRows\x12\x1b\n" +
	"\tmax_bytes\x18\x04 \x01(\x05R\bmaxBytes\"\xa3\x01\n" +
	"\x16GetSessionViewResponse\x12.\n" +
	"\x05state\x18\x01 \x01(\v2\x18.ycc.v1.SessionViewStateR\x05state\x122\n" +
	"\x04rows\x18\x02 \x03(\v2\x1e.ycc.v1.SessionPresentationRowR\x04rows\x12%\n" +
	"\x0eearlier_cursor\x18\x03 \x01(\tR\rearlierCursor\"\xa4\x01\n" +
	"\x19GetSessionViewPageRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12\x1d\n" +
	"\n" +
	"session_id\x18\x02 \x01(\tR\tsessionId\x12\x16\n" +
	"\x06cursor\x18\x03 \x01(\tR\x06cursor\x12\x19\n" +
	"\bmax_rows\x18\x04 \x01(\x05R\amaxRows\x12\x1b\n" +
	"\tmax_bytes\x18\x05 \x01(\x05R\bmaxBytes\"\xa7\x01\n" +
	"\x1aGetSessionViewPageResponse\x122\n" +
	"\x04rows\x18\x01 \x03(\v2\x1e.ycc.v1.SessionPresentationRowR\x04rows\x12%\n" +
	"\x0eearlier_cursor\x18\x02 \x01(\tR\rearlierCursor\x12.\n" +
	"\x13indexed_through_seq\x18\x03 \x01(\x03R\x11indexedThroughSeq\"m\n" +
	"\x1bGetSessionViewDetailRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12\x1d\n" +
	"\n" +
	"session_id\x18\x02 \x01(\tR\tsessionId\x12\x15\n" +
	"\x06row_id\x18\x03 \x01(\tR\x05rowId\"P\n" +
	"\x1cGetSessionViewDetailResponse\x120\n" +
	"\x03row\x18\x01 \x01(\v2\x1e.ycc.v1.SessionPresentationRowR\x03row\"W\n" +
	"\x1bSubscribeSessionViewRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x19\n" +
	"\bfrom_seq\x18\x02 \x01(\x03R\afromSeq\"\xfa\x01\n" +
	"\x11SessionViewUpdate\x12\x10\n" +
	"\x03seq\x18\x01 \x01(\x03R\x03seq\x12.\n" +
	"\x05state\x18\x02 \x01(\v2\x18.ycc.v1.SessionViewStateR\x05state\x12C\n" +
	"\rupserted_rows\x18\x03 \x03(\v2\x1e.ycc.v1.SessionPresentationRowR\fupsertedRows\x12&\n" +
	"\x0fdeleted_row_ids\x18\x04 \x03(\tR\rdeletedRowIds\x126\n" +
	"\x0ftransient_event\x18\x05 \x01(\v2\r.ycc.v1.EventR\x0etransientEvent\"{\n" +
	...
	"\x06priced\x18\b \x01(\bR\x06priced\x12\x1a\n" +
	"\bdisabled\x18\t \x01(\bR\bdisabledB\x0e\n" +
	"\f_price_inputB\x0f\n" +
	"\r_price_outputB\x13\n" +
	...
	"\x13work_implementation\x18\b \x01(\tR\x12workImplementation\"\xa0\x04\n" +
	...
	"\x04auth\x18\r \x01(\tR\x04auth\x12\x1f\n" +
	"\bdisabled\x18\x0e \x01(\bH\x04R\bdisabled\x88\x01\x01B\x0e\n" +
	"\f_price_inputB\x0f\n" +
	"\r_price_outputB\x13\n" +
	"\x11_price_cache_readB\x14\n" +
	"\x12_price_cache_writeB\v\n" +
	"\t_disabled\"Y\n" +
	...
	"\x06tokens\x18\x02 \x01(\x03R\x06tokens\"=\n" +
	"\x10TestModelRequest\x12)\n" +
	"\x05model\x18\x01 \x01(\v2\x13.ycc.v1.ModelConfigR\x05model\"\x9f\x01\n" +
	"\x11TestModelResponse\x12\x18\n" +
	...
	"\x0eDiscoverModels\x12\x1d.ycc.v1.DiscoverModelsRequest\x1a\x1e.ycc.v1.DiscoverModelsResponse\x12@\n" +
	"\tTestModel\x12\x18.ycc.v1.TestModelRequest\x1a\x19.ycc.v1.TestModelResponse\x12R\n" +
