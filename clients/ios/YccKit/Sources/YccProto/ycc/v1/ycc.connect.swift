...
public protocol Ycc_V1_SessionServiceClientInterface: Sendable {
    ...
    @available(iOS 13, *)
    func `getSessionView`(request: Ycc_V1_GetSessionViewRequest, headers: Connect.Headers) async -> ResponseMessage<Ycc_V1_GetSessionViewResponse>

    @available(iOS 13, *)
    func `getSessionViewPage`(request: Ycc_V1_GetSessionViewPageRequest, headers: Connect.Headers) async -> ResponseMessage<Ycc_V1_GetSessionViewPageResponse>

    @available(iOS 13, *)
    func `getSessionViewDetail`(request: Ycc_V1_GetSessionViewDetailRequest, headers: Connect.Headers) async -> ResponseMessage<Ycc_V1_GetSessionViewDetailResponse>

    @available(iOS 13, *)
    func `subscribeSessionView`(headers: Connect.Headers) -> any Connect.ServerOnlyAsyncStreamInterface<Ycc_V1_SubscribeSessionViewRequest, Ycc_V1_SessionViewUpdate>
...
public final class Ycc_V1_SessionServiceClient: Ycc_V1_SessionServiceClientInterface, Sendable {
    ...
    @available(iOS 13, *)
    public func `getSessionView`(request: Ycc_V1_GetSessionViewRequest, headers: Connect.Headers = [:]) async -> ResponseMessage<Ycc_V1_GetSessionViewResponse> {
        return await self.client.unary(path: "/ycc.v1.SessionService/GetSessionView", idempotencyLevel: .unknown, request: request, headers: headers)
    }

    @available(iOS 13, *)
    public func `getSessionViewPage`(request: Ycc_V1_GetSessionViewPageRequest, headers: Connect.Headers = [:]) async -> ResponseMessage<Ycc_V1_GetSessionViewPageResponse> {
        return await self.client.unary(path: "/ycc.v1.SessionService/GetSessionViewPage", idempotencyLevel: .unknown, request: request, headers: headers)
    }

    @available(iOS 13, *)
    public func `getSessionViewDetail`(request: Ycc_V1_GetSessionViewDetailRequest, headers: Connect.Headers = [:]) async -> ResponseMessage<Ycc_V1_GetSessionViewDetailResponse> {
        return await self.client.unary(path: "/ycc.v1.SessionService/GetSessionViewDetail", idempotencyLevel: .unknown, request: request, headers: headers)
    }

    @available(iOS 13, *)
    public func `subscribeSessionView`(headers: Connect.Headers = [:]) -> any Connect.ServerOnlyAsyncStreamInterface<Ycc_V1_SubscribeSessionViewRequest, Ycc_V1_SessionViewUpdate> {
        return self.client.serverOnlyStream(path: "/ycc.v1.SessionService/SubscribeSessionView", headers: headers)
    }
    ...
    public enum Metadata {
        public enum Methods {
            ...
            public static let getSessionViewDetail = Connect.MethodSpec(name: "GetSessionViewDetail", service: "ycc.v1.SessionService", type: .unary)
