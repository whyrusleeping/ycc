...
> (Once the harness exists, the `docs` package regenerates this file.)
...
| [0005](backlog/0005-multimodel-review-revise-levels.md) | Multi-model review, revise loop, interaction levels (M3) | todo | 3 | 0004 |
| [0006](backlog/0006-home-menu-modes-tui.md) | Home menu, spec/backlog/feature/bug modes, TUI (M4) | todo | 4 | 0005 |
